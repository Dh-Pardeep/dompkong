                ...
                <div className='relative' >
                    ...
                    <div className='flex absolute top-[0px] right-[50px] xl:right-0 xl:before:contents-[*] xl:before:w-[30px] xl:before:h-[30px] xl:before:bg-[#FDDA60] xl:before:top-[50%] xl:before:translate-y-[-50%] xl:before:left-[-38%] xxl:before:left-[-41%] xl:before:absolute xl:before:rounded-[50%]'>
                        ...
                        <div className='ps-[42px] flex items-start  flex-col '>
                            ...
                            <p className='font-Montserrat text-white text-[14px] lg:text-base font-normal lg:max-w-[540px] max-w-[290px]'>Mi amet elementum, posuere tempus odio eu lacinia. Natoque arcu viverra ullamcorper condimentum massa laoree</p>
                        </div>
                    </div>
                    <div className='flex absolute top-[25%] right-[12px] xl:right-0 xl:before:contents-[*] xl:before:w-[30px] xl:before:h-[30px] xl:before:bg-[#FDDA60] xl:before:top-[50%] xl:before:translate-y-[-50%] xl:before:left-[-30%] xxl:before:left-[-34%] xl:before:absolute xl:before:rounded-[50%]'>
                        ...
                        <div className='ps-[42px] flex items-start  flex-col '>
                            ...
                            <p className='font-Montserrat text-white text-[14px] lg:text-base font-normal xl:max-w-[500px] lg:max-w-[480px]  max-w-[233px]'>Amet viverra diam netus aenean at mauris, facilisis quis. Urna euismod sed ultricies arcu ullamcorper </p>
                        </div>
                    </div>
                    <div className='flex absolute  top-[54%] lg:top-[52%] right-[5px] xl:right-0 xl:before:contents-[*] xl:before:w-[30px] xl:before:h-[30px] xl:before:bg-[#FDDA60] xl:before:top-[50%] xl:before:translate-y-[-50%] xl:before:left-[-30%] xxl:before:left-[-34%] xl:before:absolute xl:before:rounded-[50%]'>
                        ...
                        <div className='ps-[38px] flex items-start  flex-col '>
                            ...
                            <p className='font-Montserrat text-white text-[14px] lg:text-base font-normal xl:max-w-[480px] lg:max-w-[460px] max-w-[214px]'>Hendrerit massa non sed sit. Lobortis in pulvinar lectus ut in elit nibh faucibus mauris. </p>
                        </div>
                    </div>
                    ...
                    <div className='flex absolute bottom-[-21%] right-[50px] xl:right-0 xl:before:contents-[*] xl:before:w-[30px] xl:before:h-[30px] xl:before:bg-[#FDDA60] xl:before:top-[50%] xl:before:translate-y-[-50%] xl:before:left-[-38%] xxl:before:left-[-42%] xl:before:absolute xl:before:rounded-[50%]'>
                        ...
                        <div className='ps-[42px] flex items-start  flex-col '>
                            ...
                            <p className='font-Montserrat text-white text-[14px] lg:text-base font-normal lg:max-w-[540px] max-w-[285px]'>Faucibus congue risus nisl dictum. A, viverra malesuada nunc varius. Ut dignissim mauris eu sed nisl neque. </p>
                        </div>
                    </div>
                </div>
            </div>
