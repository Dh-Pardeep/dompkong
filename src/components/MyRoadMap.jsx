    ...
    return (
        <section>
            <div className="container px-4 md:px-10 mx-auto xxl:px-[130px] md:pb-[100px]">
                <h2 className="text-white font-normal text-[42px] sm:text-[46px] md:text-[52px] lg:text-[58px] xl:text-[64px] font-Azo leading-none  text-center pt-[30px] lg:pt-[120px] pb-[70px]">ROADMAP</h2>
                <div className='relative ' >
                    <div className='relative md:pt-[70px]'>
                        <img className='mx-auto md:ms-0 mb-8 md:mb-0' data-aos="zoom-in" data-aos-easing="linear" data-aos-duration="1500" data-aos-delay="1000" src={TheKingKong} alt="image" />
                        <img className='absolute top-[-5%] left-[-10%] hidden md:block' src={CircelImage} alt="image" />=
                    </div>
                    <div data-aos="fade-right" data-aos-easing="linear" data-aos-duration="1500" data-aos-delay="1000" className='phase_hover before:transition-all before:ease-linear before:duration-200 flex items-center flex-col xs:flex-row md:absolute top-[0px] right-[50px] xl:right-0 xl:before:contents-[*] xl:before:w-[30px] xl:before:h-[30px] before:cursor-pointer xl:before:bg-[#FDDA60] xl:before:top-[50%] xl:before:translate-y-[-50%] xl:before:left-[-38%] xxl:before:left-[-41%] xl:before:absolute xl:before:rounded-[50%]'>
                    ...
                    <div data-aos="fade-right" data-aos-easing="linear" data-aos-duration="1500" data-aos-delay="1200" className='phase_hover  before:transition-all before:ease-linear before:duration-200 before:cursor-pointer flex items-center flex-col xs:flex-row md:absolute top-[25%] right-[12px] xl:right-0 xl:before:contents-[*] xl:before:w-[30px] xl:before:h-[30px] xl:before:bg-[#FDDA60] xl:before:top-[50%] xl:before:translate-y-[-50%] xl:before:left-[-30%] xxl:before:left-[-34%] xl:before:absolute xl:before:rounded-[50%]'>
                    ...
                    <div data-aos="fade-right" data-aos-easing="linear" data-aos-duration="1500" data-aos-delay="1400" className='phase_hover  before:transition-all before:ease-linear before:duration-200  before:cursor-pointer flex items-center flex-col xs:flex-row md:absolute  top-[54%] lg:top-[52%] right-[5px] xl:right-0 xl:before:contents-[*] xl:before:w-[30px] xl:before:h-[30px] xl:before:bg-[#FDDA60] xl:before:top-[50%] xl:before:translate-y-[-50%] xl:before:left-[-30%] xxl:before:left-[-34%] xl:before:absolute xl:before:rounded-[50%]'>
                    ...
                    <div data-aos="fade-right" data-aos-easing="linear" data-aos-duration="1500" data-aos-delay="1600" className='phase_hover  before:transition-all before:ease-linear before:duration-200  before:cursor-pointer flex items-center flex-col xs:flex-row md:absolute top-[78%] right-[5px] xl:right-0 xl:before:contents-[*] xl:before:w-[30px] xl:before:h-[30px] xl:before:bg-[#FDDA60] xl:before:top-[50%] xl:before:translate-y-[-50%] xl:before:left-[-30%] xxl:before:left-[-208px] xl:before:absolute xl:before:rounded-[50%]'>
                    ...
                    <div data-aos="fade-right" data-aos-easing="linear" data-aos-duration="1500" data-aos-delay="1800" className='phase_hover  before:transition-all before:ease-linear before:duration-200 before:cursor-pointer flex items-center flex-col xs:flex-row md:absolute bottom-[-21%] right-[50px] xl:right-0 xl:before:contents-[*] xl:before:w-[30px] xl:before:h-[30px] xl:before:bg-[#FDDA60] xl:before:top-[50%] xl:before:translate-y-[-50%] xl:before:left-[-38%] xxl:before:left-[-42%] xl:before:absolute xl:before:rounded-[50%]'>
           ...
           <div className='text-center mt-[45px] lg:mt-[66px]'>
           <Link className='text-black text-center font-Azo text-base  font-normal common_btn bg-[#FDDA60] rounded-[4px] px-6 pt-4 pb-[13px] inline-block'>READ OUR WHITEPAPER</Link>
           </div>
        </section>
    )
}
