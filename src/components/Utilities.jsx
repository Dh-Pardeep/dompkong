  ...
  return (
    <div>
      <div className="my_container">
        <h2 data-aos="fade-up" data-aos-delay="300" data-aos-easing="linear"  data-aos-duration="1500" className="text-white font-normal text-[42px] sm:text-[46px] md:text-[52px] lg:text-[58px] xl:text-[64px] font-Azo leading-none text-center pb-[54px]">UTILITIES</h2>
        <div className='flex flex-col flex-wrap sm:flex-row justify-center pb-[80px] md:pb-[120px]' >
          {DateUtilities.map((data) => {
            return (
              <div className='w-full sm:w-3/6 lg:w-2/6 flex items-center justify-center mt-5'data-aos="flip-left" data-aos-delay="300" data-aos-easing="linear"  data-aos-duration="1500">
